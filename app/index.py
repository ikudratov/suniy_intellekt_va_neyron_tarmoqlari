...
# 403-21 guruh talabasi
# fan nomi: Suniy intellekt va neyron tarmoqlari
...
def override_line(text: str) -> None:
    """
    Matnning joriy chiqish satrini almashtirish uchun yordamchi funksiya.
    """
...
class NaturalSelectionExperiment:
    ...
    def gen_initial_population(self) -> t.List[str]:
        """
        self.population_size tasodifiy shaxslar populyatsiyasini qaytaradi.
        """
    ...
    def gen_random_chromosome(self) -> str:
        """
        Tasodifiy shaxsni, ya'ni self.chromosome_length genlari tomonidan
        tuzilgan tasodifiy xromosomani qaytaradi.
        """
    ...
    def gen_new_generation(self, old_generation: t.List[str]) -> t.List[str]:
        """
        Eski generatsiyani yangi generatsiyaga o'zgartirish
        """
